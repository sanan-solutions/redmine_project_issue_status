...
unless ProjectsHelper.included_modules.include?(ProjectIssueStatuses::Patches::ProjectsHelperPatch)
  ProjectsHelper.send(:include, ProjectIssueStatuses::Patches::ProjectsHelperPatch)
end
