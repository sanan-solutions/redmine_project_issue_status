...
unless ProjectsController.included_modules.include?(RedmineProjectIssueStatus::Patches::ProjectsControllerPatch)
  ProjectsController.send(:include, RedmineProjectIssueStatus::Patches::ProjectsControllerPatch)
end