...
unless Project.included_modules.include?(RedmineProjectIssueStatus::Patches::ProjectPatch)
  Project.send(:include, RedmineProjectIssueStatus::Patches::ProjectPatch)
end